...
import { useSetNewPasswordMutation } from '../../../../store/features/auth/authSlice';
...
const ResetPassword = () => {
    ...
    const [setNewPasswordApi, { isLoading, isSuccess }] = useSetNewPasswordMutation();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await setNewPasswordApi({ newPassword }).unwrap();
            if (isSuccess) {
                router.push('/sign-in');
            }
        } catch (err) {
